...
const defaultAbout: AboutOffice = {
  id: '0',
  title: 'Sobre mim',
  description: 'Minha história começa no interior de Limoeiro do Norte–CE, na comunidade de Sítio Arraial. Filho de pais trabalhadores — servente de pedreiro e agricultores — cresci em um ambiente onde o esforço diário era regra e a dignidade vinha do trabalho honesto. Foi nesse cenário simples, mas repleto de valores sólidos, que aprendi as lições que norteiam minha vida até hoje: responsabilidade, perseverança e respeito às pessoas. Iniciei meus estudos na Escola José Alves de Moura, onde permaneci até os 14 anos. Em seguida, concluí o ensino médio na Escola Lauro Rebouças de Oliveira, aos 17 anos. Desde cedo compreendi que a educação seria o instrumento mais poderoso para transformar minha realidade e ampliar minhas oportunidades. Ao longo da juventude, exerci diversas atividades profissionais que contribuíram significativamente para minha formação pessoal e profissional. Trabalhei como entregador de farmácia, balconista, atuei no atendimento no setor de habilitação do DETRAN-CE, desempenhei funções como técnico em Licenciamento Ambiental e também como administrador. Cada uma dessas experiências fortaleceu minha disciplina, meu senso de organização e minha habilidade de lidar com pessoas e desafios cotidianos. Buscando qualificação técnica, cursei Saneamento Ambiental pelo Instituto Federal do Ceará (IFCE), formação que ampliou minha visão sobre políticas públicas, meio ambiente e gestão. Posteriormente, movido pelo propósito de atuar diretamente na defesa de direitos, ingressei no curso de Direito pela Faculdade do Vale do Jaguaribe (FVJ). A advocacia foi uma escolha pautada na vocação para servir. Ao longo da minha trajetória, investi em especializações nas áreas de Direito Previdenciário, Trabalhista e Bancário — campos jurídicos que dialogam diretamente com as necessidades da população e exigem conhecimento técnico aliado à sensibilidade social. Hoje, com mais de 8 anos de atuação na advocacia, mantenho firme o compromisso de oferecer um trabalho técnico, responsável e estratégico, sem jamais perder a essência construída nas minhas origens. Minha caminhada reflete superação, dedicação aos estudos e profundo respeito pelas pessoas que confiam em meu trabalho. Carrego comigo a consciência de onde vim e a responsabilidade de quem sabe o valor das oportunidades conquistadas. A advocacia, para mim, é mais do que profissão — é instrumento de transformação e de justiça.',
  mission: 'Oferecer serviços jurídicos de alta qualidade com ética e comprometimento. Mais do que advogar, buscamos ser agentes de transformação, garantindo que a justiça seja acessível, célere e, acima de tudo, efetiva para a preservação da dignidade e do patrimônio de nossos constituintes.',
  vision: 'Ser referência em advocacia, reconhecidos pela excelência e inovação. Almejamos ser reconhecidos não apenas pelo êxito em demandas complexas, mas pela capacidade de inovar no direito, estabelecendo novos padrões de qualidade técnica e atendimento humanizado em todo o território nacional.',
